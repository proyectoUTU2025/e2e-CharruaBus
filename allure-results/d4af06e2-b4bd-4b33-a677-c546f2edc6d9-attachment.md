  ...
  - rowgroup:
    - row "1 Admin BentancorTest 01/01/1990 admin@test.com 12345678 Admin Activo":
      ...
      - cell:
        - button
        - button
    - row "3 Cliente Test 03/03/1992 cliente@test.com 34567890 Cliente Activo":
      - cell "3"
      - cell "Cliente"
      - cell "Test"
      - cell "03/03/1992"
      ...
      - cell:
        - button
        - button
    - row "4 Cliente SinCompras 04/04/1993 cliente2@test.com 45678901 Cliente Activo":
      - cell "4"
      - cell "Cliente"
      - cell "SinCompras"
      - cell "04/04/1993"
    ...
    - row "10 asd dd 14/02/2002 2@2.com 44444444 Admin Activo":
      ...
      - cell:
        - button
        - button
    - row "9 u1 a1 02/02/2002 1a@a1.com 12343511 Admin Activo":
      - cell "9"
      - cell "u1"
      - cell "a1"
      - cell "02/02/2002"
...
- dialog:
  ...
  - text: Correo
  - textbox "Correo": user94939033@test.com
